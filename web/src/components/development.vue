  ...
  <div class="research-component" v-if="evolvingCodes.length != 0">
    ...
    >
      ...
      <div v-if="scenarioChecked" style="width: 100%">
        <h2 style="margin: 1em 0 0; font-size: 1.125em">{{ t('develop.implementation') }}</h2>
        <div>
          <el-tabs
            v-model="activeName"
            class="demo-tabs"
    ...
    <div class="content-box sm-3-size" v-show="!fullScreenFlag">
      <h2 style="font-size: 1.25em; margin-bottom: 0.8em">{{ t('research.tasks') }}</h2>
      <el-tooltip
        effect="dark"
        raw-content
        :content="
      ...
      <h2 style="margin: 1.2em 0 0; font-size: 1.125em">{{ t('develop.feedback') }}</h2>
      <div
        class="code-nav"
        :style="{
          width: developer
          ...
          feedback: [
            {
              ...
              abridgeName: t('develop.execution'),
              content: feedbacks[i].content[j].execution,
            },
            {
              name: "Code Feedback📄",
              abridgeName: t('develop.code'),
              content: feedbacks[i].content[j].code,
            },
            {
              name: "Return Checking",
              abridgeName: t('develop.return_checking'),
