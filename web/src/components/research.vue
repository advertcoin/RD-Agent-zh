        ...
        >
          ...
          >
            ...
            <div class="pdf-full" @click="zoom">
              <span class="fullscreen"></span> {{ t('research.full_screen') }}
            </div>
          </div>
          <div v-if="researchHypothesis">
            <h3>{{ t('research.hypothesis') }}</h3>
            <div>
            ...
            <h3>{{ t('research.component') }}</h3>
            <p>{{ researchHypothesis.component }}</p>
            <h3>{{ t('research.reason') }}</h3>
            <div>
            ...
            >
              ...
              <div v-else-if="field.key === 'variables'" class="task-table-wrap">
                <table class="task-table">
                  <thead>
                    <tr>
                      <th>{{ t('research.variable') }}</th>
                      <th>{{ t('research.value') }}</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr
