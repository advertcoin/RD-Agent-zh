  ...
  <div class="page-content">
    <div class="nav-bar">
      ...
      <span
        ...
        >{{ t('playground.pick_scenario') }}</span
      >
      <span class="nav-separator">></span>
    ...
    <div class="setup-content" v-show="!showPlayground">
      <div class="main-content" v-show="showPanel == 1">
        ...
        <div class="card-box">
          ...
          <div class="card-item gradient-big-border" @click="openHistoryPanel">
            <h2>{{ t('playground.view_history') }}</h2>
            <p>{{ t('playground.open_history') }}</p>
            <img
              class="img2"
              ...
              <ul>
                <li :class="{ active: tabIndex == 0 }">
                  <el-tooltip
                    ...
                    placement="bottom"
                  >
                    <span @click="tabChange(0)">{{ t('playground.continuous') }}</span>
                  </el-tooltip>
                </li>
                <li :class="{ active: tabIndex == 1 }">
                  <el-tooltip
                    ...
                    placement="bottom"
                  >
                    <span @click="tabChange(1)">{{ t('playground.guided') }}</span>
                  </el-tooltip>
                </li>
          ...
          <div class="main-panel">
            ...
            <div v-if="scenarioChecked && scenarioChecked.upload">
              <div class="title with-tip">
                {{ t('playground.material') }}
                <el-tooltip
                  effect="dark"
                  :offset="8"
                  :content="t('playground.material_tip')"
                  placement="top"
                >
              ...
              >
                <div class="upload-box">
                  <div class="upload-box-bg">
                    ...
                    <h3>{{ t('playground.upload_hint') }}</h3>
                    <p>{{ t('playground.supported_format') }}</p>
                  </div>
                </div>
              </el-upload>
            ...
            >
              <div class="title with-tip small-config-title">
                {{ t('playground.material_optional') }}
                <el-tooltip
                  effect="dark"
                  :offset="8"
                  :content="t('playground.optional_tip')"
                  placement="top"
                >
                  <span class="tip-icon">?</span>
                </el-tooltip>
              ...
              >
                <div class="upload-box">
                  <div class="upload-box-bg">
                    <span class="upload-small"></span>
                    <h3>{{ t('playground.upload_base') }}</h3>
                    <p>{{ t('playground.base_hint') }}</p>
                  </div>
                </div>
              </el-upload>
              <div class="file-tag-list" v-if="selectedFiles.length">
              ...
              <div class="compact-setting-row">
                <div class="title with-tip compact-setting-title">
                  {{ t('playground.loop_count') }}
                  <el-tooltip
                    effect="dark"
                    :offset="8"
                    :content="t('playground.loop_tip')"
                    placement="top"
                  >
                    <span class="tip-icon">?</span>
                  </el-tooltip>
                ...
                <div class="radio-box compact-config-box compact-setting-box">
                  <el-radio-group
                    ...
                    @change="radioChange"
                  >
                    <el-radio :value="'3'">3 {{ t('playground.loops') }}</el-radio>
                    <el-radio :value="'5'">5 {{ t('playground.loops') }}</el-radio>
                    <el-radio :value="'10'">10 {{ t('playground.loops') }}</el-radio>
                    <el-radio value="-1"
                      ><el-input-number
                        class="number-input"
                        v-model="num"
              ...
              <div class="compact-setting-row is-second">
                <div class="title with-tip compact-setting-title">
                  {{ t('playground.loop_hours') }}
                  <el-tooltip
                    effect="dark"
                    :offset="8"
                    :content="t('playground.hours_tip')"
                    placement="top"
                  >
                    <span class="tip-icon">?</span>
                  </el-tooltip>
                ...
                <div class="radio-box compact-config-box compact-setting-box">
                  ...
                  >
                    <el-radio :value="'6'">6 {{ t('playground.hours') }}</el-radio>
                    <el-radio :value="'12'">12 {{ t('playground.hours') }}</el-radio>
                    <el-radio :value="'24'">24 {{ t('playground.hours') }}</el-radio>
                    <el-radio value="-1"
                      ><el-input-number
                        class="number-input"
                        v-model="num1"
            ...
            >
              <button class="gradient-border back" @click="Back">{{ t('playground.back') }}</button>
              <button
                class="disable"
                v-if="!loading"
                @click="generate"
        ...
        <div class="intro-txt" v-if="scenarioCheckedIndex != -1">
          <div v-for="item in introName" :key="item">
            ...
            <markdown
              ...
              :content="t(scenarioChecked.introduce[item])"
            ></markdown>
          </div>
        </div>
      </div>
      <div class="main-content" v-show="showPanel == 3">
        <h1 class="h1">
          {{ t('playground.view_history_page') }} <br />
          {{ t('playground.view_history_desc') }}
        </h1>
        <div class="main-panel history-panel">
          <div class="title">{{ t('playground.trace_id_list') }}</div>
          <div class="desc">
            <p>{{ t('playground.trace_desc') }}</p>
          </div>
          <div class="history-select-row">
            <div class="history-select-item">
              <div class="title small-config-title">{{ t('playground.scenario') }}</div>
              <smSelectComponent
                :scenarioList="historyScenarioList"
                :scenarioIndex="historyScenarioCheckedIndex"
                :placeholder="t('playground.select_scenario')"
                @scenarioCheckedItem="historyScenarioCheckedItem"
              ></smSelectComponent>
            </div>
            <div class="history-select-item">
              <div class="title small-config-title">{{ t('playground.trace_name') }}</div>
              <smSelectComponent
                :scenarioList="historyTraceList"
                :scenarioIndex="historyTraceCheckedIndex"
                :placeholder="t('playground.select_trace_name')"
...
const continuousScenarioList = [
  {
    name: "scenario.finance_data.name",
    icon: "Piggy-Bank",
    color: "#2e65ff",
    upload: false,
    developer: true,
    ...
    loopNumber: 3,
    introduce: {
      "playground.intro": "scenario.finance_data.intro",
      "playground.data_desc": "scenario.finance_data.data_desc",
      "playground.eval_method": "scenario.finance_data.eval_method",
      "playground.breakdown": "scenario.finance_data.breakdown",
    },
  },
  {
    name: "scenario.finance_model.name",
    icon: "Piggy-Bank",
    color: "#595cff",
    upload: false,
    developer: true,
    ...
    loopNumber: 3,
    introduce: {
      "playground.intro": "scenario.finance_model.intro",
      "playground.data_desc": "scenario.finance_model.data_desc",
      "playground.eval_method": "scenario.finance_model.eval_method",
      "playground.breakdown": "scenario.finance_model.breakdown",
    },
  },
  {
    name: "scenario.finance_whole.name",
    icon: "Tablet-Capsule",
    color: "#6d52ff",
    upload: false,
    developer: true,
    ...
    loopNumber: 3,
    introduce: {
      "playground.intro": "scenario.finance_whole.intro",
      "playground.data_desc": "scenario.finance_whole.data_desc",
      "playground.eval_method": "scenario.finance_whole.eval_method",
      "playground.breakdown": "scenario.finance_whole.breakdown",
    },
  },
  {
    name: "scenario.data_science.name",
    icon: "Graph-Dot",
    color: "#a858ff",
    upload: false,
    developer: true,
    ...
    hourNumber: 24,
    introduce: {
      "playground.intro": "scenario.data_science.intro",
      "playground.data_desc": "scenario.data_science.data_desc",
      "playground.eval_method": "scenario.data_science.eval_method",
      "playground.breakdown": "scenario.data_science.breakdown",
    },
...
const visibleContinuousScenarioList = continuousScenarioList.filter(
  (scenario) => scenario.name !== "scenario.data_science.name"
);

const guidedScenarioList = [
  {
    name: "scenario.finance_reports.name",
    id: "",
    icon: "Piggy-Bank",
    color: "#475dff",
    upload: true,
    ...
    hourNumber: 24,
    introduce: {
      "playground.intro": "scenario.finance_reports.intro",
      "playground.data_desc": "scenario.finance_reports.data_desc",
      "playground.eval_method": "scenario.finance_reports.eval_method",
      "playground.breakdown": "scenario.finance_reports.breakdown",
    },
  },
  {
    name: "scenario.general_model.name",
    id: "",
    icon: "Web-Streamline",
    color: "#844bff",
    upload: true,
    ...
    hourNumber: 24,
    introduce: {
      "playground.intro": "scenario.general_model.intro",
      "playground.example_pdf": "scenario.general_model.example_pdf",
      "playground.data_desc": "scenario.general_model.data_desc",
      "playground.eval_method": "scenario.general_model.eval_method",
      "playground.breakdown": "scenario.general_model.breakdown",
    },
  },
];
