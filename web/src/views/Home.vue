<template>
  <div class="content">
    <div class="content-1">
      <h2>{{ t('home.title') }}</h2>
      <h2 class="h2"><span>{{ t('home.title2') }}</span> {{ t('home.title3') }}</h2>
      <div class="bg-1">
        <button ref="btn" @mousemove="moveMouse" @click="tryNow">
          <span>{{ t('home.try_now') }}</span>
        </button>
      </div>
    </div>
    <div class="modal">
      ...
      <div class="content-2">
        ...
        <h2 class="h2">{{ t('home.framework') }}</h2>
        <img
          src="@/assets/images/Framework.png"
          alt="R&D-Agent"
          style="margin: 3em 0 2em"
        />
        <p>{{ t('home.framework_desc') }}</p>
      ...
      <div class="content-3">
        ...
        <p>{{ t('home.dive') }}</p>
        <div class="btn-box">
          <button class="playground" @click="tryNow">{{ t('home.playground') }}</button>
            <button class="contact" @click="goToGitHub">{{ t('home.github') }}</button>
        </div>
      </div>
    </div>
  </div>
